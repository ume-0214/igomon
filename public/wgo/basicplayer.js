;(function (WGo) {
  ...
  var BasicPlayer = WGo.extendClass(WGo.Player, function (elem, config) {
    ...
    for (var key in BasicPlayer.default)
      if (this.config[key] === undefined && BasicPlayer.default[key] !== undefined)
        this.config[key] = BasicPlayer.default[key]
      ...
      case 'InvalidMoveError':
        this.showMessage(
          '<h1>' +
            ...
            '</h1><p>' +
            err.message +
            '</p><p>If this message isn\'t correct, please report it by clicking <a href="' +
            url +
            '">here</a>, otherwise contact maintainer of this site.</p>',
        )
        break
      case 'FileError':
        this.showMessage(
      ...
      default:
        this.showMessage(
          '<h1>' +
            ...
            '</p><pre>' +
            err.stacktrace +
            '</pre><p>Please contact maintainer of this site. You can also report it <a href="' +
            url +
            '">here</a>.</p>',
        )
    }
